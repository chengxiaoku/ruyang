		...
		<?php  if(is_array($system_menu)) { foreach($system_menu as $permission_name => $menu) { ?>
			<tr>
				...
				<td>
					...
					<?php  } ?>
					<a href="javascript:;" ng-click="editMainMenu(<?php  echo intval($menu['displayorder'])?>, '<?php  echo $permission_name;?>')" class="we7-margin-right-sm link-group we7-padding-right">编辑</a>
				</td>
			</tr>
