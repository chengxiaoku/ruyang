...
<ul class="nav nav-tabs">    
    ...
    <li><a href="<?php  echo $this->createWebUrl('storetype')?>">商家分类管理</a></li>
    <li class="active"><a href="<?php  echo $this->createWebUrl('addstoretype')?>">添加商家分类</a></li>
</ul>
        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
              ...
              <!--   <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')" name="money" class="form-control" value="<?php  echo $info['money'];?>" />
                  </div>
              </div> -->
                <div class="form-group">
