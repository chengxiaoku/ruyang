...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('yellowset')?>">黄页入驻设置</a></li>
   <!--  <?php  if($count['total']<3) { ?> -->
    <li><a href="<?php  echo $this->createWebUrl('addyellowset')?>">添加黄页入驻</a></li>
    <!-- <?php  } ?> -->
</ul>
<div class="main">
    <!-- 门店列表部分开始 -->
                ...
                <div class="row">
                    <table class="yg5_tabel col-md-12">
                        ...
                        <tr class="yg5_tr2">
                            ...
                            <td>
                                <a href="<?php  echo $this->createWebUrl('addyellowset', array('id' => $row['id']))?>" class="storespan btn btn-xs">
                            ...
                            <!-- <a class="btn btn-warning btn-xs" href="<?php  echo $this->createWebUrl('addyellowset', array('id' => $row['id']))?>" title="编辑">改</a>&nbsp;&nbsp;
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('yellowset', array('id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
