        ...
        <form action="" method="get" class="col-md-3">
          ...
          <input type="hidden" name="do" value="information" />
            <div class="input-group" style="width: 300px">
                <input type="text" name="keywords" class="form-control" value="<?php  echo $_GPC['keywords'];?>" placeholder="请输入任务联系人名称/电话/内容">
                    ...
                    <tr class="yg5_tr2">
                       ...
                       <td>
                          <?php  if($item['state']==1) { ?>
                           ...
                           <?php  if($user['state']==1) { ?>
                      <a href="" data-toggle="modal" data-target="#myModala<?php  echo $item['user_id'];?>"><button class="btn storegrey2 btn-xs">拉黑用户</button></a>
