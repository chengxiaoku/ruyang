        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         <label class="radio-inline">
                            <input type="radio" id="emailwy7" name="is_dnss" value="1" <?php  if($item['is_dnss']==1 || empty($item['is_dnss'])) { ?>checked<?php  } ?> />
                            <label for="emailwy7">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="emailwy8" name="is_dnss" value="2" <?php  if($item['is_dnss']==2) { ?>checked<?php  } ?> />
