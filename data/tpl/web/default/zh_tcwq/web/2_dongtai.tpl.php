            ...
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    <tr class="yg5_tr1">
                        ...
                        <td style="width: 50px;">动态ID</td>
                        <td class="col-md-1">动态发布者昵称</td>
                        <td class="col-md-3">动态内容</td>
                        <td class="col-md-1">动态发布时间</td>
                        <td class="col-md-">是否私密</td>
                        <td class="col-md-1">点赞数</td>
                        
                        <td class="col-md-1">评论数</td>
                        <td class="col-md-1">打赏总金额</td>
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <td>
                            ...
                            <?php  if($item['is_display']==1) { ?>
                                对好友可见
                            <?php  } else if($item['is_display']==2) { ?>
                                对好友不可见
                            <?php  } ?>
                        </td>
                        <td><?php  echo $item['dianzan_num'];?></td>
                        <td><?php  echo $item['pinglun_num'];?></td>
                        <td>￥ <?php  echo $item['money_sum'];?></td>
                        <!-- 动态状态 -->
                        <td>
                            <?php  if($item['is_forbidden']==1) { ?>
                            已发送
                            <?php  } else if($item['is_forbidden']==2) { ?>
                            禁用
                            <?php  } ?>
                        </td>
                        ...
                        <td>
                            <?php  if($item['is_forbidden']==1) { ?>
                            <div class="btn btn-md storewarning2" data-toggle="modal" data-target="#myModal<?php  echo $item['id'];?>" >禁用</div>
                            <?php  } else if($item['is_forbidden']==2) { ?>
                            <div class="btn btn-md storesuccess2" data-toggle="modal" data-target="#myModall<?php  echo $item['id'];?>">取消禁用</div>
                            <?php  } ?>
                        </td>
                        <!--
                        <td>
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<?php  echo $this->createWebUrl('dongtai', array('op' => 'forbidden', 'id' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                            </div>
                    </div>
                </div>
            </div>
                    <!-- 取消禁用 start-->
                    <div class="modal fade" id="myModall<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
